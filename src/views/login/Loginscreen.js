...
const Styledtextinput = (props) => {
  ...
  return (
    <View>
      ...
      <View style={{ flexDirection: "row", alignItems: 'center', justifyContent: "space-between" }} between>
        {props.error ? (
          <Text
        ...
        {props.password &&
          <TouchableOpacity
            onPress={() => Alert.alert('Contact Support team to reset password')}
          >
            <Text
        ...
        <View
          ...
          <View style={{
            ...
            <View>
              ...
              >
                India's first All in one Invoice app - Invo
              </Text>
              <Text
                style={styles.logintext}
              >
                  ...
                  return (
                    <>
                      <Styledtextinput
                        ...
                        maxLength={8}
                        keyboardType='numeric' MaterialCommunityIcons
